class ApiEndpoints {
  ...
  static const String maintenanceSchedulePrefix = '$baseUrl/maintenance/schedules';
  ...
  static String checkUserNameExists(String name) => '$userPrefix/check/name/$name';
  static String checkUserEmailExists(String email) => '$userPrefix/check/email/$email';
  ...
  static String checkCategoryCodeExists(String code) => '$categoryPrefix/check/code/$code';
  ...
  static String checkLocationCodeExists(String code) => '$locationPrefix/check/code/$code';
  ...
  static String checkAssetTagExists(String tag) => '$assetPrefix/check/tag/$tag';
  static String checkAssetSerialExists(String serial) => '$assetPrefix/check/serial/$serial';
  ...
  static String getScanLogsByUserId(String userId) => '$scanLogPrefix/user/$userId';
  static String getScanLogsByAssetId(String assetId) => '$scanLogPrefix/asset/$assetId';
  ...
  static const String getNotificationsStatistics = '$notificationPrefix/statistics';
  ...
  static String checkNotificationExists(String id) => '$notificationPrefix/check/$id';
  static String getNotificationById(String id) => '$notificationPrefix/$id';
  static String markNotificationAsRead(String id) => '$notificationPrefix/$id/read';
  static String markNotificationAsUnread(String id) => '$notificationPrefix/$id/unread';
  static const String markAllNotificationsAsRead = '$notificationPrefix/mark-all-read';
  ...
  static const String getIssueReportsStatistics = '$issueReportPrefix/statistics';
  ...
  static String checkIssueReportExists(String id) => '$issueReportPrefix/check/$id';
  ...
  static String resolveIssueReport(String id) => '$issueReportPrefix/$id/resolve';
  ...
  static const String getAssetMovementsStatistics = '$assetMovementPrefix/statistics';
  ...
  static String checkAssetMovementExists(String id) => '$assetMovementPrefix/check/$id';
  static String getAssetMovementsByAssetId(String assetId) => '$assetMovementPrefix/asset/$assetId';
  ...
  static const String getMaintenanceRecordsCursor = '$maintenanceRecordPrefix/cursor';
  static const String countMaintenanceRecords = '$maintenanceRecordPrefix/count';
  static String checkMaintenanceRecordExists(String id) => '$maintenanceRecordPrefix/check/$id';
  static const String getMaintenanceRecordsStatistics = '$maintenanceRecordPrefix/statistics';
  static String getMaintenanceRecordById(String id) => '$maintenanceRecordPrefix/$id';
  static String updateMaintenanceRecord(String id) => '$maintenanceRecordPrefix/$id';
  static String deleteMaintenanceRecord(String id) => '$maintenanceRecordPrefix/$id';
  ...
  static const String getMaintenanceSchedulesCursor = '$maintenanceSchedulePrefix/cursor';
  static const String countMaintenanceSchedules = '$maintenanceSchedulePrefix/count';
  static String checkMaintenanceScheduleExists(String id) => '$maintenanceSchedulePrefix/check/$id';
  static const String getMaintenanceSchedulesStatistics = '$maintenanceSchedulePrefix/statistics';
  static String getMaintenanceScheduleById(String id) => '$maintenanceSchedulePrefix/$id';
  static String updateMaintenanceSchedule(String id) => '$maintenanceSchedulePrefix/$id';
  static String deleteMaintenanceSchedule(String id) => '$maintenanceSchedulePrefix/$id';
}
