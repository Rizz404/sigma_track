...
class BulkDeleteMaintenanceSchedulesUsecase
  ...
  BulkDeleteMaintenanceSchedulesUsecase(this._maintenanceScheduleRepository);

  @override
  Future<Either<Failure, ItemSuccess<BulkDeleteResponse>>> call(
    BulkDeleteParams params,
  ) async {
    return await _maintenanceScheduleRepository.deleteManyMaintenanceSchedules(
      params,
    );
  }
}
