...
class ExportAssetListUsecase
    implements Usecase<ItemSuccess<Uint8List>, ExportAssetListUsecaseParams> {
  final AssetRepository _assetRepository;

  ExportAssetListUsecase(this._assetRepository);

  @override
  Future<Either<Failure, ItemSuccess<Uint8List>>> call(
    ExportAssetListUsecaseParams params,
  ) async {
    return await _assetRepository.exportAssetList(params);
  }
}

class ExportAssetListUsecaseParams extends Equatable {
  ...
  const ExportAssetListUsecaseParams({
  ...
  ExportAssetListUsecaseParams copyWith({
    ExportFormat? format,
    String? searchQuery,
    AssetStatus? status,
    ...
    return ExportAssetListUsecaseParams(
  ...
  factory ExportAssetListUsecaseParams.fromMap(Map<String, dynamic> map) {
    return ExportAssetListUsecaseParams(
  ...
  factory ExportAssetListUsecaseParams.fromJson(String source) =>
      ExportAssetListUsecaseParams.fromMap(json.decode(source));

  @override
  String toString() =>
      'ExportAssetListUsecaseParams(format: $format, searchQuery: $searchQuery, status: $status, condition: $condition, categoryId: $categoryId, locationId: $locationId, assignedTo: $assignedTo, brand: $brand, model: $model, sortBy: $sortBy, sortOrder: $sortOrder, includeDataMatrixImage: $includeDataMatrixImage)';
