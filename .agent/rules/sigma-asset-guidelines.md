...
# Antigravity Workspace Rules — Sigma Track (Flutter)

You are pairing on the Sigma Track Flutter codebase.
...
- Never use print().
- Use: import 'package:sigma_track/core/utils/logging.dart';
...
- Always prefer shared components from:
  - 'package:sigma_track/shared/widgets/...'
